...
class GMPHDTest(TestCase):
    ...
    def setUp(self):
        ...
        # self.birthgmm_4 = []
        # for x in range(-50, 0, 10):
        #     for y in range(-50, 0, 10):
        #         target = Target(init_state=np.array([[x], [y], [0.0], [0.0]]))
        #         self.birthgmm_4.append(target)
        ...
        self.filternode_3 = PHDFilterNode(3, self.birthgmm_3,
                                          region=[(-25, 25), (-50, 50)])
        # self.filternode_4 = PHDFilterNode(4, self.birthgmm_4,
        #                                   region=[(-50, 0), (-50, 0)])
    ...
    #     print(self.filternode_1.targets[0].weight)
    ...
    #     assert len(self.filternetwork.node_share) == 1
    ...
    #
    #     assert len(self.filternetwork.node_keep[3][0]) == 1

    # def test_fuse_covs(self):
    #     self.filternetwork.step_through(self.generator.observations[0])
    #     self.filternetwork.share_info(1)
    #     self.filternetwork.get_closest_comps(1)
    #     print(self.filternetwork.node_keep[1])
